...
<link rel="stylesheet"
	...
	<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/dist/css/style2.css">
<!-- Morris chart -->
<link rel="stylesheet"
...
<body class="hold-transition bg-img2">
	<div class="wrapper">
		...
		<header class="main-header bg-img">
			...
			<a href="/" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				...
				<span class="logo-lg"> <img
					src="${pageContext.request.contextPath }/resources/dist/img/muf.png"></span>
			</a>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								...
								class="hidden-xs txt-white">Adhi Yoga Sepriyanto</span>
						</a>
...
<!-- 									<div class="row">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					<li class="header txt-white" >MAIN NAVIGATION</li>


					<li><a href="${pageContext.request.contextPath }/"><i  class="fas fa-grip-horizontal txt-white"> Dashboard</i></a></li>
					<li><a href="${pageContext.request.contextPath }/member"><i  class="fas fa-user-alt txt-white"> Member</i></a></li>
					<li><a href="${pageContext.request.contextPath }/asset"><i  class="fas fa-database txt-white"> Asset</i></a></li>
		...
		<div class="content-wrapper">
			<div class="muf1">
				<h1 class="muf">Mandiri Utama FInance</h1>
				...
				<!--   <a target="_blank" href="/member">"Member"</a> link.</p> -->
			</div>
